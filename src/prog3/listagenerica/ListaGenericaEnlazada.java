...
/*
	public ListaGenericaEnlazada<T> invertir() {
		...
		ListaGenericaEnlazada<T> p = new ListaGenericaEnlazada<T>();

		//Lo que hago acá es copiar todos los datos de this a p//
		System.out.println("llego");
		while (!this.fin()) {
			p.agregarFinal(this.proximo());
		}
		p.comenzar();
		p = p.inv();
	...
	public ListaGenericaEnlazada<T> inv() {
		...
		this.comenzar();
		this.agregarFinal(this.actual.getDato());
